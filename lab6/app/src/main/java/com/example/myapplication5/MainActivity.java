        ...
        buttonAvtorization.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Thread(()-> {
                    ...
                    if (status) {
                        statusAvtorization.post(() -> statusAvtorization.setText("Вы авторизированны"));
                        buttonResetPassword.post(()->buttonResetPassword.setEnabled(true));
                        buttonCreateProf.post(()->buttonCreateProf.setEnabled(false));
                        name.post(()->name.setEnabled(false));
                    } else {
                        statusAvtorization.post(()-> statusAvtorization.setText("Вы не авторизированны"));
                        buttonResetPassword.post(()->buttonResetPassword.setEnabled(false));
                        buttonCreateProf.post(()->buttonCreateProf.setEnabled(true));
                        name.post(()->name.setEnabled(true));
                    }
                }).start();
